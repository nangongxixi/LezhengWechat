<?php /* Smarty version Smarty-3.1.6, created on 2017-03-13 10:37:04
         compiled from "./LezhengWechat/Home/View\Myinfo\SureShenq.html" */ ?>
<?php /*%%SmartyHeaderCode:879358a4124632a142-15960795%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '89aed7fdc72d17a4f1914663c423ec50fe2186c6' => 
    array (
      0 => './LezhengWechat/Home/View\\Myinfo\\SureShenq.html',
      1 => 1489233968,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '879358a4124632a142-15960795',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_58a41246502c3',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58a41246502c3')) {function content_58a41246502c3($_smarty_tpl) {?><html>
    <head>
        <meta charset="UTF-8" />
...
headimg.png" class="headimg">
    ...
    <div class="baibg mianzexy_padd">
        ...
        <div class="orderinfo_xqitem input_title">
            ...
            <div class="orderinfo_xqtitle">交易金额：</div>
        </div>
        <div class="clear"></div>
    </div>
    <div class="fenge"></div>
...
tel.png" class="tel_ico">
    ...
    <div class="conntbottom_line"></div>
    <div class="mianzxy input_title mianzxy_text">● 您确定要申请退款吗？申请退款后不可取消。</div>
</div>
<div class="conntbottom_line"></div>
<div class="submit_button" id="submit" onclick="WeixinJSBridge.call('closeWindow');">确认申请</div>
    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                //订单状态映射(全局)
                        var viewstatus;
                        var orderstatus = data.orderstatus;//根据订单状态显示列表样式                        
                        if (data.department == '') {
