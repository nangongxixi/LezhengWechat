<?php /* Smarty version Smarty-3.1.6, created on 2017-03-24 13:56:25
         compiled from "./LezhengWechat/Home/View\Epsquery\addinfo.html" */ ?>
<?php /*%%SmartyHeaderCode:21358a13e25873b20-54857948%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '350d1b10b829d612e8d23924f5fe512dc3d935af' => 
    array (
  ...
  'nocache_hash' => '21358a13e25873b20-54857948',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_58a13e25ab5da',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58a13e25ab5da')) {function content_58a13e25ab5da($_smarty_tpl) {?><html>
    <head>
        <meta charset="UTF-8" />
...
del.png" class="delinput"></div>
        ...
        <div class="input_padd bottom_line  input_bg">
            <span class="input_title">办事区域：</span>&nbsp;<input type="text" name="area" value="" onclick="javascript:$(this).blur()" placeholder="请选择（必填）" id="area" maxlength="11" class="input_box all_tex"/>           
        </div>
        <div class="input_padd bottom_line  input_bg">
...
09.png"></div><div class="left jibenxx input_title">留言</div>
        ...
        <div class="textarea_padd">
            <textarea name="message" class="textarea_box input_box all_tex" id="message" placeholder="必填，留下你的特殊情况内容，我们将与你取得联系，请耐心等待。"></textarea>            
        </div>
    </div>
...
";	
            ...
            var xuq = $.trim(sessionStorage.getItem('xuq'));
            var qujianarea = sessionStorage.getItem('qujianarea');
			if(qujianarea == null){
				qujianarea = "<?php echo $_SESSION['user']['areaname'];?>
";
...
";	
			...
			var message = sessionStorage.getItem('qujianarea');
            if (people == '') {                
                layer.open({
                    content: '必须填写需求人',
                    time: 2,
